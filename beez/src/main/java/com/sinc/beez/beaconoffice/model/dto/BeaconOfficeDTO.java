package com.sinc.beez.beaconoffice.model.dto;
...
public class BeaconOfficeDTO {
	...
	public BeaconOfficeDTO(String beacon_id, String beacon_addr,
			String beacon_position, String beacon_alias, int floor_num,
	...
	public String toString() {
		return "BeaconOfficeDTO [beacon_id=" + beacon_id + ", beacon_addr="
				+ beacon_addr + ", beacon_position=" + beacon_position
				+ ", beacon_alias=" + beacon_alias + ", floor_num=" + floor_num
